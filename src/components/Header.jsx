...
export default function Speakers() {
  return (
    <div className="page speakers">
      ...
      {/* Navbar links without Contact */}
      <nav className="navbar-links" style={{ marginTop: "1.2rem", display: "flex", gap: "2.2rem", justifyContent: "center" }}>
        <a href="/" className="navbar-link">Home</a>
        <a href="/about" className="navbar-link">About</a>
        <a href="/speakers" className="navbar-link">Speakers</a>
        <a href="/nomination" className="navbar-link">Nomination</a>
